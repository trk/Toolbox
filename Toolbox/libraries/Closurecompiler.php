...
{
    protected $java;
    protected $compilerJar = 'compiler.jar';
    ...
    {
        $this->compilerJar = MODPATH . 'Toolbox' . DIRECTORY_SEPARATOR . 'libraries' . DIRECTORY_SEPARATOR . 'closure' . DIRECTORY_SEPARATOR . $this->compilerJar;
    }
    ...
    public function getBinary()
    {
        ...
        if (!$this->java) {
            ...
            if (!$this->java) {
                throw new Exception('java could not be found in PATH.');
            }
        }
    ...
    public function setSourceBaseDir($path = '')
    {
        if (file_exists($path)) {
            ...
            throw new Exception("The path '{$path}' does not seem to exist.");
        }
    }
    ...
    public function compile()
    {
        ...
        if (in_array($this->config['targetFileName'], $this->config['sourceFileNames'])) {
            throw new Exception("The target file '{$this->config['targetFileName']}' is one of the source files. A compile would cause undesired effects.");
        }
