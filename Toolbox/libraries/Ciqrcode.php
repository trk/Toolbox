...
class Ciqrcode
{
	...
	public function initialize($config = array()) {
		...
		include $this->qr_libraries_path . 'qrcode' . DIRECTORY_SEPARATOR . "qrconst.php";
		include $this->qr_libraries_path . 'qrcode' . DIRECTORY_SEPARATOR . "qrtools.php";
		include $this->qr_libraries_path . 'qrcode' . DIRECTORY_SEPARATOR . "qrspec.php";
		include $this->qr_libraries_path . 'qrcode' . DIRECTORY_SEPARATOR . "qrimage.php";
		include $this->qr_libraries_path . 'qrcode' . DIRECTORY_SEPARATOR . "qrinput.php";
		include $this->qr_libraries_path . 'qrcode' . DIRECTORY_SEPARATOR . "qrbitstream.php";
		include $this->qr_libraries_path . 'qrcode' . DIRECTORY_SEPARATOR . "qrsplit.php";
		include $this->qr_libraries_path . 'qrcode' . DIRECTORY_SEPARATOR . "qrrscode.php";
		include $this->qr_libraries_path . 'qrcode' . DIRECTORY_SEPARATOR . "qrmask.php";
		include $this->qr_libraries_path . 'qrcode' . DIRECTORY_SEPARATOR . "qrencode.php";
	}
